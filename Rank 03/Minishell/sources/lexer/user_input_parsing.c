...
/*   Updated: 2025/07/23 11:19:38 by tstevens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// check les erreurs de syntax simples avant parsing/lexing
...
// expand var et delete quotes
static bool	validate_and_expand_tokens(t_data *data)
{
	if (process_token_variables(&data->token) == FAILURE)
	{
