...
// connecte une chaine replacement dans la liste doublement chainee 
...
// cas specifique ou le token a remplacer est en tete de liste
...
// remplacer un token unique par une chaine de token
