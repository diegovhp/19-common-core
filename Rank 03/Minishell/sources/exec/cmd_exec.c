...
/*   Updated: 2025/08/07 16:13:21 by tstevens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*Tente d'exécuter une commande système 
en cherchant son chemin absolu et en appelant execve.*/
...
/*Exécute une commande locale (avec chemin explicite)
via execve après vérification de sa validité.*/
...
et les pipes avant l'exécution de la commande.*/
...
/*Exécute une commande builtin en appelant
la fonction correspondante selon le nom de la commande.*/
...
/*Exécute une commande : prépare l'environnement,
tente le builtin, puis la commande système ou locale, et termine le processus.*/
