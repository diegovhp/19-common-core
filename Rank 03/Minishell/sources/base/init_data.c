...
/*   Updated: 2025/08/07 16:39:32 by tstevens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*Copie les variables d'environnement dans une
nouvelle zone mémoire associée à la structure data.*/
...
/*Initialise les chemins de travail
courants et précédents dans la structure data.*/
...
incluant l'environnement, les répertoires
de travail et les pointeurs internes.*/
...
/*Alloue et initialise une nouvelle structure
io_fds pour la commande si elle n'en possède pas.*/
