...
// manually init command without args
...
// apply init empty cmd args a tous les t_command si necessaire
...
// envoie le token vers la fonction correspondant a son type
...
// main function. build liste chainee de commandes a partir de token stream
