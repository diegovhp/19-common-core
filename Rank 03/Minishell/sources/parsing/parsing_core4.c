...
//detect if chain contient au moins 1 espace
...
//takes expanded var with several words words: first becomes main command
// others added to list of args
...
//called when token type = WORD/VAR
