...
// create absolute path based on relative filename
...
// init output redirect > ecrase fichier sortie
...
// fonction call depuis main parsing quand >
...
//same as init output truncate mode but for >>
