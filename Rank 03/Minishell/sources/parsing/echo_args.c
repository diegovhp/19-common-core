...
// allocate char ** tab containing existing count + new_count + 1
...
// tant qu'il reste un WORD/VAR, faire avancer current dans liste chainee
...
// filter empty tokens, count new args, alloc tab of right size,
// copy old args into new, maj lastcmd->args avec nv tab
...
// filter empty tokens, calcul cb d'args necessaires, alloc lastcmd->args
// stock cmd into args[0], loop token WOR/VAR, NULL term, maj token node
