...
/*   Updated: 2025/08/07 16:08:49 by tstevens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/* Alloue dynamiquement un tableau de 
deux entiers pour les descripteurs de pipe.*/
...
/* Crée un pipe pour une commande et stocke 
ses descripteurs dans la structure t_command.*/
...
en fonction des pipes des commandes précédentes et suivantes.*/
...
/* Initialise les pipes nécessaires entre 
les différentes commandes chaînées (pipeline).*/
...
/* Ferme les descripteurs de pipe 
inutilisés pour éviter les fuites de ressources.*/
