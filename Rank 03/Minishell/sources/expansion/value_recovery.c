...
/*   Updated: 2025/07/23 12:58:06 by tstevens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*get_var_value(t_data *data, char *variable_name, t_token *token)
{
	char	*variable_value;
					...
					char *input_string, t_data *data)
{
	...
	variable_value = get_var_value(data, variable_name, token);
